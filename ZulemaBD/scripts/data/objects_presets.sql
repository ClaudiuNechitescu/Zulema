...
USING (VALUES
  (N'z_preset_consultas_activas',N'z_consulta',N'Consultas activas',N'Consulta.IdEstado=1',N'check',NULL,N'txt-success',0,0,1)
) AS Source ([PresetName],[ObjectName],[Title],[Filter],[IconName],[IconClass],[TitleClass],[Order],[Offline],[Originid])
...
WHEN NOT MATCHED BY TARGET THEN
 INSERT([PresetName],[ObjectName],[Title],[Filter],[IconName],[IconClass],[TitleClass],[Order],[Offline],[Originid])
 VALUES(Source.[PresetName],Source.[ObjectName],Source.[Title],Source.[Filter],Source.[IconName],Source.[IconClass],Source.[TitleClass],Source.[Order],Source.[Offline],Source.[Originid])
